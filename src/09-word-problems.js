...
// let totalCost = products.priceInCents * products.quantity
// // totalCost / 100
// // totalCost.toFixed(2)
 ...
 * compareLocations()
 * ---------------------
 * A shipping company is looking to make its deliveries more efficient by comparing the destinations
 * of multiple deliveries. If the locations are similar, the packages may be able to be bundled 
 * together.
 * 
 ...
 * 
 * - If the street, city, state, and zip for both addresses are the same, return the string 
 * "Same building."
